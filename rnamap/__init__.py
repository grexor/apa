...
"""
    ...
    for t in ["tandem", "composite", "skipped"]:
        ...
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip.%s.siteup.png" % t, "clip.%s.siteup.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip.%s.sitedown.png" % t, "clip.%s.sitedown.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>iCLIP<br>cont.</td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_freq.%s.siteup.png" % t, "clip_freq.%s.siteup.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_freq.%s.sitedown.png" % t, "clip_freq.%s.sitedown.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>iCLIP<br><font color=red>top 20 enh</font></td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_heat.%s.siteup_pos.png" % t, "clip_heat.%s.siteup_pos.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_heat.%s.sitedown_pos.png" % t, "clip_heat.%s.sitedown_pos.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>iCLIP<br><font color=blue>top 20 rep</font></td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_heat.%s.siteup_neg.png" % t, "clip_heat.%s.siteup_neg.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("clip_heat.%s.sitedown_neg.png" % t, "clip_heat.%s.sitedown_neg.png" % t))
        f.write("</tr>")
    ...
    for t in ["tandem", "composite", "skipped"]:
        ...
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq.%s.siteup.png" % t, "seq.%s.siteup.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq.%s.sitedown.png" % t, "seq.%s.sitedown.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>UG<br>cont.</td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_freq.%s.siteup.png" % t, "seq_freq.%s.siteup.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_freq.%s.sitedown.png" % t, "seq_freq.%s.sitedown.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>UG<br><font color=red>top 20 enh</font></td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_heat.%s.siteup_pos.png" % t, "seq_heat.%s.siteup_pos.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_heat.%s.sitedown_pos.png" % t, "seq_heat.%s.sitedown_pos.png" % t))
        f.write("</tr>")
        f.write("<tr>")
        f.write("<td align=right valign=center>UG<br><font color=blue>top 20 rep</font></td>")
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_heat.%s.siteup_neg.png" % t, "seq_heat.%s.siteup_neg.png" % t))
        f.write("<td align=right valign=center><a href=%s class='highslide' onclick='return hs.expand(this)'><img src=%s width=350px></a></td>" % ("seq_heat.%s.sitedown_neg.png" % t, "seq_heat.%s.sitedown_neg.png" % t))
        f.write("</tr>")
        f.write("<tr><td><br><br></td><td><br><br></td><td><br><br></td></tr>")
        f.write("\n")
